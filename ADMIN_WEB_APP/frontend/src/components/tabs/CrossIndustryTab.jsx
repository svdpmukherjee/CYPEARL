...
export const CrossIndustryTab = ({
  ...
  const getPersonaName = (clusterId) => {
    ...
    return aiName || label?.name || `P${parseInt(clusterId) + 1}`;
  };
  if (!clusteringResult) {
    return (
      <EmptyState
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Analyze whether personas are consistent across different
              industries
            </p>
          </div>
          <button
          ...
          <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-red-600 mt-2">
                Tip: Make sure the backend is running and you've run clustering
                first.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div
                  className={`text-2xl font-bold ${
                    industryAnalysis.domain_transferable
                      ? "text-green-600"
                      : "text-amber-600"
                  }`}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {Object.entries(industryAnalysis.distribution || {}).map(
                  ([ind, data]) => (
                    <div key={ind} className="p-4 border rounded-lg">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {Object.entries(data.percentages || {}).map(
                          ([c, pct]) => (
                            <span
                              key={c}
                              ...
                              style={{
                                backgroundColor:
                                  CLUSTER_COLORS[
                                    parseInt(c) % CLUSTER_COLORS.length
                                  ] + "20",
                                color:
                                  CLUSTER_COLORS[
                                    parseInt(c) % CLUSTER_COLORS.length
          ...
          !error && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                Click "Analyze Industries" to run cross-domain analysis
              </p>
              <p className="text-sm text-gray-400 mt-2">
                This will test whether your personas are consistent across
