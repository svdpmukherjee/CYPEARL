...
const ActionModal = ({ isOpen, onClose, onSubmit, actionType }) => {
    ...
    const [perceivedRelevance, setPerceivedRelevance] = useState(4);
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl p-8 my-auto max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg space-y-6">
                        ...
                        {/* Perceived Work Relevance (REQUIRED) */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                How relevant is this email to the type of emails you typically receive in your actual job? (1-7)
                            </label>
                            <div className="flex items-center space-x-4">
                                <input
                                    type="range"
                                    ...
                                    onChange={(e) => setPerceivedRelevance(parseInt(e.target.value))}
                                    className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-teal-600"
                                />
                                <span className="font-bold text-teal-600 w-8 text-center text-lg bg-white px-2 py-1 rounded">
                                    {perceivedRelevance}
                                </span>
                            </div>
                            <div className="flex justify-between text-xs text-gray-500 mt-1">
                    ...
                    <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-md text-white font-medium shadow-sm transition-colors
                                ...
                                ${!['report', 'safe'].includes(actionType) ? 'bg-blue-600 hover:bg-blue-700' : ''}
                            `}
                        >
                            Submit Response
                        </button>
