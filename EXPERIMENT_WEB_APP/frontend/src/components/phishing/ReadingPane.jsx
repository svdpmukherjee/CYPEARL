    ...
    <div className="relative">
      ...
      >
        ...
        {isExpanded ? (
          <ChevronUp
            size={14}
            className="ml-1 text-[#605e5c] group-hover:text-[#252423]"
          />
        ) : (
          <ChevronDown
            size={14}
...
const ReadingPane = ({
  ...
  const recordMicroAction = useCallback(
    ...
    return (
      <div className="flex-1 bg-white flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-semibold text-[#252423] mb-2">
            That's all.
          </h2>
          <p className="text-[#605e5c] text-lg">Thanks for your time.</p>
          <p className="text-sm text-[#a19f9d] mt-4">
            Click any email on the left to review it.
          </p>
        </div>
      </div>
    );
  ...
  if (email.order_id === 0) {
    return (
      <div className="flex-1 bg-white flex flex-col overflow-hidden">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <div className="text-xs text-[#605e5c] mt-0.5">to me</div>
              </div>
            </div>
        ...
        {/* Auto-advance notice */}
        <div className="p-4 bg-blue-300 border-t border-blue-100 ">
          <p className="text-sm text-black font-medium tracking-[0.12em] uppercase">
            Please read this welcome email carefully. The first email will
            arrive shortly...
          </p>
        </div>
      </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <SenderDetailsPanel
                ...
                onToggle={() =>
                  setSenderDetailsExpanded(!senderDetailsExpanded)
                }
